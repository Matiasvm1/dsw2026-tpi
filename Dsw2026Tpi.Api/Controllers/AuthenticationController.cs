...
public class AuthenticationController : AppController
{
    ...
    [Authorize(Policy = Policies.AdminPolicy)]   // solo un admin puede crear otro admin
    ...
    [EnableRateLimiting(RateLimitPolicies.AdminLogin)]   // RL-01: 5/min por IP
    [ProducesResponseType(StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status400BadRequest)]
    ...
    [EnableRateLimiting(RateLimitPolicies.PatientLogin)]   // RL-02: 10/min por IP
    [ProducesResponseType(StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status400BadRequest)]
    [ProducesResponseType(StatusCodes.Status401Unauthorized)]
    [ProducesResponseType(StatusCodes.Status429TooManyRequests)]
